<!-- <main class="d-flex w-100" style="background-image: url('<?= base_url() ?>assets/logo/bg-gt.jpg'); background-repeat: no-repeat;background-size: 100% 100%;"> -->
<main class="d-flex w-100" style="background-image: linear-gradient(to right, #800000 , #F1C40F);">
