			...
			<div class="modal-body">
				<div class="container">
					...
					<div class="text-center mt-5 mb-3">
						<button id="btn_print_nota" type="button" class="btn btn-primary">
...
<script>
	...
	function print_nota(id) {
		...
		window.open('<?= base_url() ?>Prints/print_nota_pembelian/' + id, 'page', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=900,height=750,left=50,top=50,titlebar=yes')
	}
</script>
